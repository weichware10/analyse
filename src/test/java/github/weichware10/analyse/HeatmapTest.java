...
public class HeatmapTest {
    ...
    public void createHeatmapShouldWork() {
        Heatmap hm1 = new Heatmap(new TrialData(ToolType.ZOOMMAPS, "1", "3"), new ConfigHeatmap());
        ...
        Heatmap hm2 = new Heatmap(new TrialData(ToolType.EYETRACKING, "7", "3"), new ConfigHeatmap());
        ...
        Heatmap hm3 = new Heatmap(new TrialData(ToolType.CODECHARTS, "3", "3"), new ConfigHeatmap());
    ...
    public void compHeatmapsShouldWork() {
        Heatmap hm1 = new Heatmap(new TrialData(ToolType.CODECHARTS, "4", "3"), new ConfigHeatmap());
        Heatmap hm2 = new Heatmap(new TrialData(ToolType.EYETRACKING, "2", "3"), new ConfigHeatmap());
        assertEquals(
        ...
        Heatmap hm3 = new Heatmap(new TrialData(ToolType.ZOOMMAPS, "1", "3"), new ConfigHeatmap());
        Heatmap hm4 = new Heatmap(new TrialData(ToolType.CODECHARTS, "6", "3"), new ConfigHeatmap());
        assertEquals(
        ...
        Heatmap hm5 = new Heatmap(new TrialData(ToolType.EYETRACKING, "8", "3"), new ConfigHeatmap());
        Heatmap hm6 = new Heatmap(new TrialData(ToolType.ZOOMMAPS, "12", "3"), new ConfigHeatmap());
        assertEquals(
